    ...
    <div className={style.body}>
      <div className={style.container}>
        ...
        <div className={style.mobileCard}>
          ...
          the block and hello to stress-free parking. With real-time
          availability, seamless navigation, and secure payments, Parkify makes
          parking a breeze. Join the parking revolution today and experience the
          future of parking!
          <div className={style.buttons}>
            <button
